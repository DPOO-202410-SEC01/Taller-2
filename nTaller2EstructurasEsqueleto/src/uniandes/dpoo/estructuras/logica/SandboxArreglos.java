...
public class SandboxArreglos
{
     ...
     */
    public int[] copiaArregloEnteros;
    public String[] copiaArregloCadenas;
    ...
    public void insertarEntero( int entero, int posicion )
    {
        ...
        int[] nuevoArreglo = new int[size + 1];
        System.arraycopy(arregloEnteros, 0, nuevoArreglo, 0, posicion);
        nuevoArreglo[posicion] = entero;
        System.arraycopy(arregloEnteros, posicion, nuevoArreglo, posicion + 1, size - posicion);
        arregloEnteros = nuevoArreglo;
    }
