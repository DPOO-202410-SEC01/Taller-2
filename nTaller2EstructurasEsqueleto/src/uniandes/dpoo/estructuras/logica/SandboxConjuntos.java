...
public class SandboxConjuntos
{
    ...
    public void volverMayusculas( )
    {
        ...
        arbolCadenas.clear();
        arbolCadenas.addAll(nuevoConjunto);
    }
    ...
    {
    	Set<String> conjuntoComparacion = new HashSet<>(Arrays.asList(otroArreglo));
        return arbolCadenas.containsAll(conjuntoComparacion);
    }
